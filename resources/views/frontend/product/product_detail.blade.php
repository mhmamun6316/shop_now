                                            ...
                                            @foreach ($multiImgs as $multiImg)
                                                <div class="item">
                                                    <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                        data-slide="1" href="#slide{{ $multiImg->id }}">
                                    ...
                                    <div class="products">
                                        <div class="product">
                                            ...
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="{{ url('product/detail/' . $relatedProduct->id) }}"><img
                                                            src="{{ asset($relatedProduct->product_thambnail) }}"
                                                            alt=""></a>
                                                </div><!-- /.image -->
                                                ...
                                                <div>
                                                    @if ($relatedProduct->discount_price == null)
                                                        <div class="tag new"><span style="font-size: 10px ">Not
                                                            </span></div>
                                                    @else
                                            ...
                                            <div class="product-info text-left">
                                                <h3 class="name"><a
                                                        href="{{ url('product/detail/' . $relatedProduct->id) }}">{{ $relatedProduct->product_name }}</a>
                                                </h3>
                                                <div class="rating rateit-small"></div>
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    <span class="price-before-discount">$
                                                        {{ $relatedProduct->selling_price }}</span>
                                                </div><!-- /.product-price -->
                                            </div><!-- /.product-info -->
