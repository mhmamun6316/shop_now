  ...
  <div class="body-content outer-top-xs" id="top-banner-and-menu">
    <div class="container">
      <div class="row"> 
              ...
              <div class="item">
                <div class="products">
                  <div class="hot-deal-wrapper">
                    <div class="image"> <img src="{{ asset($hot->product_thambnail )}} " alt=""> </div>
                  ...
                  <div class="product-info text-left m-t-20">
                    <h3 class="name"><a href="detail.html">{{ $hot->product_name }}</a></h3>
                    <div class="rating rateit-small"></div>
                    <div class="product-price"> <span class="price"> ${{ $hot->discount_price }}</span> <span class="price-before-discount">${{ $hot->selling_price }}</span> </div>
                    <!-- /.product-price --> 
                        ...
                        <div class="row product-micro-row">
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              ...
                              <div class="rating rateit-small"></div>
                              <div class="product-price"> <span class="price"> ${{ $special_deal->selling_price }} </span> </div>
                              <!-- /.product-price --> 
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
              ...
              <div class="item item-carousel">
                <div class="products">
                  <div class="product">
                    <div class="product-image">
                      <div class="image"> <a href="detail.html"><img  src=" {{ asset($feature->product_thambnail) }} " alt=""></a> </div>
                      <!-- /.image -->
                    ...
                    <div class="product-info text-left">
                      <h3 class="name"><a href="detail.html">{{ $feature->product_name }}</a></h3>
                      <div class="rating rateit-small"></div>
                      <div class="description"></div>
                      <div class="product-price"> <span class="price"> ${{ $feature->discount_price }} </span> <span class="price-before-discount">${{ $feature->selling_price }}</span> </div>
                      <!-- /.product-price --> 
        ...
        <!-- /.section --> 
        <!-- == ==== skip product (first categroy products) END ==== === --> 

        <!-- == === skip product (second categroy products) == ==== -->
        ...
        <!-- /.section --> 
        <!-- == ==== skip product (second categroy products) END ==== === --> 
        ...
        <!-- == === skip brand (first brands product) == ==== -->
        ...
        <!-- == ==== skip brand (first brands product) END ==== === --> 
