                                                    ...
                                                    <div class="row product-micro-row">
                                                        <div class="col col-xs-5">
                                                            <div class="product-image">
                                                                <div class="image"> <a href="#"> <img
                                                                            src="{{ asset($special_offer->product_thambnail) }} "
                                                                            alt=""> </a> </div>
                                                                <!-- /.image -->
                                                        ...
                                                        <div class="col col-xs-7">
                                                            <div class="product-info">
                                                                <h3 class="name"><a
                                                                        href="#">{{ $special_offer->product_name }}</a>
                                                                </h3>
                                                                <div class="rating rateit-small"></div>
                                                                <div class="product-price"> <span
                                                                        class="price">{{ $special_offer->selling_price }}</span>
                                                                </div>
                                                                <!-- /.product-price -->
                                                ...
                                                <div class="product-micro">
                                                    <div class="row product-micro-row">
                                                        <div class="col col-xs-5">
                                                            <div class="product-image">
                                                                <div class="image"> <a href="#"> <img
                                                                            src="{{ asset($special_deal->product_thambnail) }} "
                                                                            alt=""> </a> </div>
                                                                <!-- /.image -->
                                                        ...
                                                        <div class="col col-xs-7">
                                                            <div class="product-info">
                                                                <h3 class="name"><a
                                                                        href="#">{{ $special_deal->product_name }}</a>
                                                                </h3>
                                                                <div class="rating rateit-small"></div>
                                                ...
                                                <div class="products">
                                                    <div class="product">
                                                        <div class="product-image">
                                                            ...
                                                            <div>
                                                                @if ($product->discount_price == null)
                                                                    <div class="tag new"><span>Not Discount</span>
                                                                    </div>
                                                                @else
                                                                    <div class="tag hot">
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a
                                                                    href="{{ url('product/detail/' . $product->id) }}">{{ $product->product_name }}</a>
                                                            </h3>
                                                            <div class="rating rateit-small"></div>
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src=" {{ asset($feature->product_thambnail) }} " alt=""></a>
                                                </div>
                                                <!-- /.image -->
                                                ...
                                                <div>
                                                    ...
                                                    @else
                                                        <div class="tag hot"><span>{{ round($discount) }}
                                                                %</span></div>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="product-info text-left">
                                                <h3 class="name"><a
                                                        href="detail.html">{{ $feature->product_name }}</a></h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="description"></div>
                                                <div class="product-price"> <span class="price">
                                                        ${{ $feature->discount_price }} </span> <span
                                                        class="price-before-discount">${{ $feature->selling_price }}</span>
                                                </div>
                                                <!-- /.product-price -->
